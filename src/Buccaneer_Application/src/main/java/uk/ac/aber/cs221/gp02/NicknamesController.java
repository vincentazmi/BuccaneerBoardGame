...
public class NicknamesController extends MainMenuController {
    ...
    /**
     * Create nickname array and check names
     */
    ...
    /**
     * Enable/Disable play button depending on validity of nicknames
     */
    ...
    private boolean checkValidity() {
        ...
        for (TextField txt : textFields) {
            ...
            if (txt.getText().length() > 15) { // nicknames must be 15 or fewer characters long
    ...
    /**
     * Play button if enabled and clicked, set nicknames and initialize game
     * @param event
     * @throws IOException
     */
    @FXML
