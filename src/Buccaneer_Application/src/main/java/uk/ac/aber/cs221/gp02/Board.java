...
public class Board {
    ...
    /**
     * It places all the elements on the board
     */
    ...
    /**
     * It assign board elements to the appropriate positions
     */
     ...
     * @param x xCor
     * @param y yCor
     * @param boardElement element to be assigned
     */
    ...
    /**
     * It initializes all the textures
    ...
    /**
     * It changes color of tiles which can be clicked
     */
    ...
    /**
     * It checks if the square is legal
     * @param x xCor
     * @param y yCor
