...
public class Port extends BoardElement {
    ...
    private ArrayList<Treasure> safeZone;
    ...
    public void setSafeZone(ArrayList<Treasure> safeZone) {
    ...
    /**
     * This method allows adding treasures to the safe zone
     *
     * @param treasure is a treasure to be added
     */
    public void addTreasureToSafeZone(Treasure treasure) {
        safeZone.add(treasure);
    }

    /**
     * This method retrieves the safe zone
     * @return safeZone
     */

    public ArrayList<Treasure> getSafeZone(){
        return safeZone;
    }
    ...
    /**
     * This method returns array of ints which represents each safe zone
     * @return int representation of safe zones in the list
     */

    public int[] safeZoneDescription() {
        int[] desc = new int[5];

        for (Treasure t : safeZone)
            switch (t.getType()) {
                case DIAMOND -> desc[0]++;
                case RUBIN -> desc[1]++;
                case GOLD -> desc[2]++;
