...
final public class Game {
    ...
    private static void inPort() {
        if (!(board.getTile(currentPlayer.getXCor(), currentPlayer.getYCor()).getElement() instanceof Port))
        {
