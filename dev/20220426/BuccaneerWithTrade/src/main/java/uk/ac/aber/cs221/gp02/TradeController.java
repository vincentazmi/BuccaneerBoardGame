...
public class TradeController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        portCardsSliders = new Slider[] {port1BSlider,port2BSlider,port3BSlider,port1RSlider, port2RSlider, port3RSlider};
        playerCardsSliders = new Slider[] {player1BSlider,player2BSlider,player3BSlider,player1RSlider, player2RSlider, player3RSlider};
        ...
        portCardsAvailableValue = new Label[] {port1BAvailableValue, port2BAvailableValue, port3BAvailableValue, port1RAvailableValue, port2RAvailableValue, port3RAvailableValue};
        ...
        playerCardsAvailableValue = new Label[] {player1BAvailableValue, player2BAvailableValue, player3BAvailableValue, player1RAvailableValue, player2RAvailableValue, player3RAvailableValue};
